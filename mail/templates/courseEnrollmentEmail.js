exports.courseEnrollmentEmail = (courseName, name) => {
  return `<!DOCTYPE html>
    ...
    <body>
        <div class="container">
            <a href=""><img class="logo" src="https://res.cloudinary.com/loordhujeyakumar-cloudinary/image/upload/v1732930430/qfzyescjivsr50y6kyz3.png"
                    alt="Intelearn Logo"></a>
            ...
            <a href="mailto:loordhujeyakumar@gmail.com">loordhujeyakumar@gmail.com</a>. We are here to help!</div>
        </div>
    </body>
